...
namespace Xmaxplatform {
   ...
   chainhttp_plugin::chainhttp_plugin():my(new chainhttp_plugin_impl()){}
   chainhttp_plugin::~chainhttp_plugin(){}
   ...
   void chainhttp_plugin::plugin_initialize(const variables_map& options) {
   ...
   void chainhttp_plugin::plugin_startup() {
   ...
   void chainhttp_plugin::plugin_shutdown() {
