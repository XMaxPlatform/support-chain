...
namespace Xmaxplatform {
    ...
    *
    *  The handler will be called from the baseapp application io_service
    ...
    *  plugins.  
    */
   class chainhttp_plugin : public Baseapp::plugin<chainhttp_plugin>
   {
      public:
        chainhttp_plugin();
        virtual ~chainhttp_plugin();
      ...
      private:
        std::unique_ptr<class chainhttp_plugin_impl> my;
   };
...
FC_REFLECT(Xmaxplatform::error_results, (code)(message)(details))
