...
public:
   simple_symbol_table():
      known({ "field", "struct_t", "asset_symbol", "asset", "address","share_type", "name", "field_name", "fixed_string16", "fixed_string32",
...
FC_REFLECT(Xmaxplatform::Basetypes::simple_symbol_table, (typedefs)(structs))
