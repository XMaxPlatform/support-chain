#define BOOST_TEST_MODULE basechain test
...
struct book : public Basechain::object<0, book> {
...
typedef multi_index_container<
  ...
  >,
  Basechain::allocator<book>
> book_index;

BASECHAIN_SET_INDEX_TYPE( book, book_index )
...
BOOST_AUTO_TEST_CASE( open_and_create ) {
   ...
   try {
      ...
      Basechain::database db(temp, database::read_write, 1024*1024*8);
      Basechain::database db2(temp); /// open an already created db
