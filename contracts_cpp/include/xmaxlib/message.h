...
extern "C" {
    ...
    *
    *
    * A XMAX.Xmaxplatform message has the following abstract structure:
    *
    * ```
    *   struct message {
    ...
    * print(Name(code)); // Output: xmax
    *
    * assert(Name(current_code()) === "xmax", "This message expects to be received by xmax"); // Do nothing
