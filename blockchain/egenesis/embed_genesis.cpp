...
using Xmaxplatform::Native_contract::genesis_state_type;
...
"// XMAX_EGENESIS_JSON to specify an embedded genesis state.          //\n"
"//                                                                  //\n"
;

// hack:  import create_example_genesis() even though it's a way, way
// specific internal detail
namespace Xmaxplatform { namespace app { namespace detail {
genesis_state_type create_example_genesis();
} } } // Xmaxplatform::app::detail
...
{ try {
   int main_return = 0;
   boost::program_options::options_description cli_options("XMAX Chain Identifier");
